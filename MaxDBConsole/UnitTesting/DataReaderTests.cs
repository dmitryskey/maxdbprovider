	...
	public class DataReaderTests
	{
		...
		public void Init() 
		{
			try
			{
				...
				(new MaxDBCommand("CREATE TABLE Test (id INT NOT NULL, name VARCHAR(100), d DATE, t TIME, dt TIMESTAMP, b1 LONG BYTE, c1 LONG ASCII, PRIMARY KEY(id))", m_conn)).ExecuteNonQuery();
			}
			catch(Exception ex)
			{
