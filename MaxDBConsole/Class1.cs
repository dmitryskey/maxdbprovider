...
//                }
				...
				using (MaxDBCommand cmd = new MaxDBCommand("SELECT * FROM HOTEL --WHERE zip = :b", maxdbconn))
				{
					//cmd.Parameters.Add(":a", MaxDBType.LongA).Direction = ParameterDirection.Output;
