//-----------------------------------------------------------------------------------------------
// <copyright file="MaxDBTransaction.cs" company="2005-2021 Dmitry S. Kataev, 2002-2003 SAP AG">
...
namespace MaxDB.Data
{
    ...
    public sealed class MaxDBTransaction : DbTransaction
    {
        ...
        public override void Commit()
        {
            ...
            Connection.Comm.Commit(Connection.ConnArgs);
        }
        ...
        /// </remarks>
        public override IsolationLevel IsolationLevel => Connection.Comm.IsolationLevel;
        ...
        public override void Rollback()
        {
            ...
            Connection.Comm.Rollback(Connection.ConnArgs);
        }
