//-----------------------------------------------------------------------------------------------
// <copyright file="MaxDBDataReader.cs" company="2005-2021 Dmitry S. Kataev, 2002-2003 SAP AG">
...
namespace MaxDB.Data
{
    ...
    public sealed class MaxDBDataReader : DbDataReader, ISqlParameterController
    {
        ...
        internal MaxDBDataReader(MaxDBConnection connection, FetchInfo fetchInfo, MaxDBCommand cmd, int maxRows, IMaxDBReplyPacket reply)
        {
        ...
        private void LogValue(int i, IDBTechTranslator transl, string type, int size, int minusLen, string value)
        {
        ...
        IMaxDBConnection ISqlParameterController.Connection => this.dbConnection;

        IByteArray ISqlParameterController.ReplyData => this.mCurrentChunk?.ReplyData;
        ...
        */
        ...
        private IByteArray CurrentRecord
        {
            get
            {
                if (this.mPositionState == PositionType.BEFORE_FIRST)
        ...
        private IDBTechTranslator FindColumnInfo(int colIndex)
        {
            ...
            try
            {
                return this.mFetchInfo.GetColumnInfo(colIndex);
            }
