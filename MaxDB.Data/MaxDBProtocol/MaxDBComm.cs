//-----------------------------------------------------------------------------------------------
// <copyright file="MaxDBComm.cs" company="2005-2021 Dmitry S. Kataev, 2002-2003 SAP AG">
...
namespace MaxDB.Data.MaxDBProtocol
{
    ...
    internal sealed class MaxDBComm : IMaxDBComm
    {
        ...
        /// </summary>
        public IParseInfoCache ParseCache { get; private set; }

        /// <summary>
        /// Gets a network socket.
        /// </summary>
        public IMaxDBSocket Socket { get; private set; }

        /// <summary>
        /// Gets a request packets pool.
        /// </summary>
        public Stack<IMaxDBRequestPacket> PacketPool { get; private set; } = new Stack<IMaxDBRequestPacket>();

        /// <summary>
        /// Gets an Unicode request packets pool.
        /// </summary>
        public Stack<IMaxDBRequestPacket> UnicodePacketPool { get; private set; } = new Stack<IMaxDBRequestPacket>();
        ...
        public byte[] Execute(IMaxDBRequestPacket userPacket, int len)
        {
        ...
        public bool IsKernelFeatureSupported(int feature) => this.byKernelFeatures[(2 * (feature - 1)) + 1] == 1;
        ...
        public void Open(ConnectArgs connArgs, bool initSocket = true)
        {
            ...
            requestPacket.InitDbsCommand(connectCmd, false);
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        public IMaxDBRequestPacket GetRequestPacket()
        {
        ...
        public void FreeRequestPacket(IMaxDBRequestPacket requestPacket)
        {
        ...
        public IMaxDBReplyPacket Execute(ConnectArgs connArgs, IMaxDBRequestPacket requestPacket, object execObj, int gcFlags) =>
        ...
        /// <returns>Reply packet.</returns>
        [MethodImpl(MethodImplOptions.Synchronized)]
        public IMaxDBReplyPacket Execute(ConnectArgs connArgs, IMaxDBRequestPacket requestPacket, bool ignoreErrors, bool isParse, object execObj, int gcFlags)
        {
            int requestLen;
        ...
        private bool InitiateChallengeResponse(ConnectArgs connArgs, IMaxDBRequestPacket requestPacket, string user, Crypt.Auth auth)
        {
