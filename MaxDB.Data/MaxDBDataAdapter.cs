//-----------------------------------------------------------------------------------------------
// <copyright file="MaxDBDataAdapter.cs" company="2005-2021 Dmitry S. Kataev, 2002-2003 SAP AG">
...
namespace MaxDB.Data
{
    ...
    /// </para>
    /// <para>The <B>MaxDBDataAdapter</B> also includes the <see cref="SelectCommand"/>,
    /// <see cref="InsertCommand"/>, <see cref="DeleteCommand"/>,
    /// <see cref="UpdateCommand"/>, and <see cref="DataAdapter.TableMappings"/>
