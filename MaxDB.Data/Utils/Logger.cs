...
namespace MaxDB.Data.Utils
{
    ...
    public class MaxDBLogger
    {
        internal const int NumSize = 4;

        internal const int TypeSize = 16;

        internal const int LenSize = 10;
        ...
        internal MaxDBLogger()
        {
        }

        internal bool TraceSQL => this.mSwitcher.TraceSQL;

        internal bool TraceFull => this.mSwitcher.TraceFull;

        internal void SqlTrace(DateTime dt, string msg)
        {
        ...
        internal void SqlTraceParseInfo(DateTime dt, object objInfo)
        {
        ...
        internal void SqlTraceDataHeader(DateTime dt) => this.SqlTrace(dt, "I".PadRight(NumSize) + "T".PadRight(TypeSize) + "L".PadRight(LenSize) + "I".PadRight(InputSize) + "DATA");
        ...
        private static void SqlTraceTransl(IDBTechTranslator info)
        {
